...
QT_MOC_LITERAL(3, 26, 9), // "EmetreFov"
QT_MOC_LITERAL(4, 36, 5), // "value"
QT_MOC_LITERAL(5, 42, 10), // "CanviarFov"
QT_MOC_LITERAL(6, 53, 12) // "Canviarmodel"

    },
    "MyGLWidget\0returnPressed\0\0EmetreFov\0"
    "value\0CanviarFov\0Canviarmodel"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->EmetreFov((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->CanviarFov((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->Canviarmodel(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::returnPressed)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::EmetreFov)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::returnPressed(const QString & _t1)
{
...
// SIGNAL 1
void MyGLWidget::EmetreFov(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
